...
%			\path (SLEEP) edge [bend left] node {\# $>3$s} (FIRST);
	...
	\end{center}
\end{figure}
Figure 1 shows the semantics of the state transitions, which was kept exactly the same between labs
...
Figure 2 shows the overall architecture of the system, including the organization of the threads in
Lab 4.\\\\
\begin{figure}[h]
